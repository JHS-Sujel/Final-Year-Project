...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-info"
                                                    href="<?php echo e(route('product-types.edit', $item->id)); ?>"><i
    ...
    <section id="ecommerce-pagination">
        <div class="row">
            <div class="col-sm-12">
                <nav>
                    <?php echo e($product_types->render()); ?>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineordering\resources\views//product-types/index.blade.php ENDPATH**/ ?>