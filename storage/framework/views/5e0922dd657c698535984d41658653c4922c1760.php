<?php $__env->startSection('title', 'Update Order'); ?>
    ...
    <section class="card invoice-page">
        <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-customer-details" class="row pt-2">
                <?php if(isset($customer) && isset($customer->shipping_address)): ?>
                ...
                <p>Transfer the amounts to the business amount below. Please include invoice number on your check.
                    <?php if($order->status == 0): ?>
                        <p class="bank-details mb-0">
                            <a href="<?php echo e(route('orders.update', $order->id)); ?>" class="btn btn-success">Confirm</a>
                            <a href="<?php echo e(route('orders.cancel', $order->id)); ?>" class="btn btn-warning">Cancel</a>
                        </p>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineordering\resources\views//orders/edit.blade.php ENDPATH**/ ?>