...
<?php if($configData["mainLayoutType"] == 'horizontal'): ?>
    <footer class="footer <?php echo e($configData['footerType']); ?> footer-light navbar-shadow">
<?php else: ?>
    <footer class="footer <?php echo e($configData['footerType']); ?> footer-light">
<?php endif; ?>
...
<!-- END: Footer-->
<?php /**PATH C:\xampp\htdocs\onlineordering\resources\views/panels/footer.blade.php ENDPATH**/ ?>