        ...
        <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
                <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                        ...
                        <span>
                            <img class="round" src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>"
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="ml-0 mr-50"><img src="<?php echo e(asset('images/icons/xls.png')); ?>" alt="png" height="32" />
                </div>
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="ml-0 mr-50"><img src="<?php echo e(asset('images/icons/jpg.png')); ?>" alt="png" height="32" />
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="ml-0 mr-50"><img src="<?php echo e(asset('images/icons/pdf.png')); ?>" alt="png" height="32" />
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between w-100" href="#">
            <div class="d-flex">
                <div class="ml-0 mr-50"><img src="<?php echo e(asset('images/icons/doc.png')); ?>" alt="png" height="32" />
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" alt="png"
                        height="32" /></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" alt="png"
                        height="32" /></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-14.jpg')); ?>" alt="png"
                        height="32" /></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
            <div class="d-flex align-items-center">
                <div class="avatar mr-50"><img src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" alt="png"
                        height="32" /></div>
                <div class="search-data">
...
<!-- END: Header-->
<?php /**PATH C:\xampp\htdocs\onlineordering\resources\views/panels/navbar.blade.php ENDPATH**/ ?>